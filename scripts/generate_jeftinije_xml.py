"""
Generira statični jeftinije-feed.xml za portal jeftinije.hr

Pokretanje:
    python scripts/generate_jeftinije_xml.py

Izlaz: jeftinije-feed.xml u korijenu projekta (ili gdje je definiran OUTPUT_FILE)
Taj fajl pošalji jeftinije.hr timu.

Cijene se čitaju iz Google Sheeta (isti Sheet kao kalkulator i outreach).
"""
...
KATALOG_SHEET_ID = os.getenv("KATALOG_SHEET_ID", "1YmRZMeomWxAmfi6rsLN6qKrHrrAeHOnGVbnfsZXP3w4")
SHEET_NAME       = "CJENIK"
COL_SKU          = 0   # A
COL_PRICE        = 4   # E = Prodajna Cijena SA PDV
BASE_URL         = "https://2lmf-pro.hr"
OUTPUT_FILE      = os.path.join(os.path.dirname(__file__), "..", "jeftinije-feed.xml")

CREDENTIALS_FILE = os.path.join(os.path.dirname(__file__), "..", "..", "2lmf-outreach", "credentials.json")
TOKEN_FILE       = os.path.join(os.path.dirname(__file__), "..", "..", "2lmf-outreach", "token.json")

# fileUnder konstante
FU_ELECTRANE = "Elektronika > Baterije i akumulatori > Prijenosne elektrane"
FU_SOLAR     = "Elektronika > Baterije i akumulatori > Solarni paneli"
FU_SATOR     = "Sport i rekreacija > Kampiranje i planinarenje > Krovni šatori za automobile"
FU_KAMP_OPR  = "Sport i rekreacija > Kampiranje i planinarenje > Oprema za kampiranje"

PRODUCTS = [
    # ── PECRON ────────────────────────────────────────────────────────────────
    {"sku": "5001", "brand": "Pecron", "fileUnder": FU_ELECTRANE,
    ...
    {"sku": "5002", "brand": "Pecron", "fileUnder": FU_ELECTRANE,
    ...
    {"sku": "5003", "brand": "Pecron", "fileUnder": FU_ELECTRANE,
    ...
    {"sku": "5004", "brand": "Pecron", "fileUnder": FU_ELECTRANE,
    ...
    {"sku": "5005", "brand": "Pecron", "fileUnder": FU_ELECTRANE,
    ...
    {"sku": "5009", "brand": "Aferiy", "fileUnder": FU_ELECTRANE,
    ...
    {"sku": "5012", "brand": "Aferiy", "fileUnder": FU_ELECTRANE,
    ...
    {"sku": "5013", "brand": "Aferiy", "fileUnder": FU_ELECTRANE,
    ...
    {"sku": "5014", "brand": "Aferiy", "fileUnder": FU_ELECTRANE,
    ...
    {"sku": "5015", "brand": "Aferiy", "fileUnder": FU_ELECTRANE,
    ...
    {"sku": "5016", "brand": "Aferiy", "fileUnder": FU_ELECTRANE,
    ...
    {"sku": "5027", "brand": "Aferiy", "fileUnder": FU_ELECTRANE,
    ...
    {"sku": "5028", "brand": "Aferiy", "fileUnder": FU_ELECTRANE,
    ...
    {"sku": "5017", "brand": "Aferiy", "fileUnder": FU_SOLAR,
    ...
    {"sku": "5018", "brand": "Aferiy", "fileUnder": FU_SOLAR,
    ...
    {"sku": "5019", "brand": "Aferiy", "fileUnder": FU_SOLAR,
    ...
    # ── OSCAL ─────────────────────────────────────────────────────────────────
    {"sku": "5029", "brand": "OSCAL", "fileUnder": FU_ELECTRANE,
    ...
    {"sku": "5020", "brand": "OSCAL", "fileUnder": FU_ELECTRANE,
    ...
    {"sku": "5021", "brand": "OSCAL", "fileUnder": FU_ELECTRANE,
    ...
    {"sku": "5022", "brand": "OSCAL", "fileUnder": FU_ELECTRANE,
    ...
    {"sku": "5023", "brand": "OSCAL", "fileUnder": FU_ELECTRANE,
    ...
    {"sku": "5024", "brand": "OSCAL", "fileUnder": FU_ELECTRANE,
    ...
    {"sku": "5025", "brand": "OSCAL", "fileUnder": FU_SOLAR,
    ...
    {"sku": "5026", "brand": "OSCAL", "fileUnder": FU_SOLAR,
    ...
    # ── PAKETI ────────────────────────────────────────────────────────────────
    {"sku": "5030", "brand": "2LMF PRO", "fileUnder": FU_ELECTRANE,
    ...
    {"sku": "5031", "brand": "2LMF PRO", "fileUnder": FU_ELECTRANE,
    ...
    {"sku": "5032", "brand": "2LMF PRO", "fileUnder": FU_ELECTRANE,
    ...
    # ── CAMPBOXI ──────────────────────────────────────────────────────────────
    {"sku": "6001", "brand": "CampBoxi", "fileUnder": FU_SATOR,
    ...
    {"sku": "6002", "brand": "CampBoxi", "fileUnder": FU_SATOR,
    ...
    {"sku": "6003", "brand": "CampBoxi", "fileUnder": FU_KAMP_OPR,
    ...
    {"sku": "6004", "brand": "CampBoxi", "fileUnder": FU_KAMP_OPR,
    ...
    {"sku": "6005", "brand": "CampBoxi", "fileUnder": FU_KAMP_OPR,
    ...
    {"sku": "6007", "brand": "CampBoxi", "fileUnder": FU_KAMP_OPR,
    ...
    {"sku": "6008", "brand": "CampBoxi", "fileUnder": FU_KAMP_OPR,
    ...
    # ── TENTBOX ───────────────────────────────────────────────────────────────
    {"sku": "6009", "brand": "TentBox", "fileUnder": FU_SATOR,
    ...
    {"sku": "6010", "brand": "TentBox", "fileUnder": FU_SATOR,
    ...
    {"sku": "6011", "brand": "TentBox", "fileUnder": FU_SATOR,
    ...
    {"sku": "6012", "brand": "TentBox", "fileUnder": FU_SATOR,
    ...
    {"sku": "6013", "brand": "TentBox", "fileUnder": FU_SATOR,
    ...
    {"sku": "6014", "brand": "TentBox", "fileUnder": FU_KAMP_OPR,
...
def get_prices():
    try:
        ...
        ws    = gc.open_by_key(KATALOG_SHEET_ID).worksheet(SHEET_NAME)
        ...
        for row in data[1:]:
            ...
            price = str(row[COL_PRICE]).strip().replace(",", ".")
            try:
                val = float(price)
                if sku and val > 0:
                    prices[sku] = val
        ...
        print(f"  UPOZORENJE: Ne mogu čitati Sheet ({e})")
        print("  Generiram XML bez cijena (dodaj ručno).")
        return {}
...
def build_xml(prices):
    lines = ['<?xml version="1.0" encoding="UTF-8"?>', "<CNJExport>"]
    ...
    for p in PRODUCTS:
        ...
        img_url     = p["img"] if p["img"].startswith("http") else f"{BASE_URL}/{p['img']}"
        product_url = f"{BASE_URL}/proizvod.html?sku={p['sku']}"
        price_fmt   = f"{price:.2f}".replace(".", ",")

        specs_html = "<ul>" + "".join(
            f"<li><strong>{k}:</strong> {v}</li>" for k, v in p["specs"]
        ) + "</ul>"

        attrs_xml = "\n".join(
            f"      <attribute>\n"
            f"        <name>{cdata(k)}</name>\n"
            f"        <values><value>{cdata(v)}</value></values>\n"
            f"      </attribute>"
            for k, v in p["specs"]
        )
        ...
        lines += [
            "  <Item>",
            f"    <ID>{cdata(p['sku'])}</ID>",
            f"    <name>{cdata(p['name'])}</name>",
            f"    <description>{cdata('<p>' + p['desc'] + '</p>')}</description>",
            f"    <specifications>{cdata(specs_html)}</specifications>",
            f"    <link>{cdata(product_url)}</link>",
            f"    <mainImage>{cdata(img_url)}</mainImage>",
            f"    <price>{price_fmt}</price>",
            f"    <curCode>EUR</curCode>",
            f"    <stock>preorder</stock>",
            f"    <stockText>{cdata('Naručite online')}</stockText>",
            f"    <fileUnder>{cdata(p['fileUnder'])}</fileUnder>",
            f"    <brand>{cdata(p['brand'])}</brand>",
            f"    <EAN></EAN>",
            f"    <productCode>{cdata(p['sku'])}</productCode>",
            f"    <condition>{cdata('new')}</condition>",
            f"    <warranty>{cdata('24 mjeseca')}</warranty>",
            f"    <deliveryCost>0,00</deliveryCost>",
            f"    <deliveryTimeMin>3</deliveryTimeMin>",
            f"    <deliveryTimeMax>7</deliveryTimeMax>",
            f"    <groupId></groupId>",
            f"    <attributes>",
            f"      <gender></gender>",
            f"      <color></color>",
    ...
    lines.append("</CNJExport>")

    if skipped:
        print(f"  Preskočeno {skipped} proizvoda bez cijene u Sheetu.")

    return "\n".join(lines)


def main():
    print("Čitam cijene iz Google Sheeta...")
    prices = get_prices()
    print(f"  Pronađeno {len(prices)} cijena.")

    print("Generiram XML...")
    xml = build_xml(prices)

    output = os.path.abspath(OUTPUT_FILE)
    with open(output, "w", encoding="utf-8") as f:
        f.write(xml)

    print(f"\nGotovo! Fajl spremen: {output}")
    print("Pošalji jeftinije-feed.xml jeftinije.hr timu.")
